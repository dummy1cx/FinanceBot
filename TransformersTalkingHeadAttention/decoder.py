...
import torch
from talking_head_attention import TakingHeadAttention
...
class DecoderLayer(nn.Module) :
    def __init__(self , model_dimension , num_heads , inner_layer_dimension , dropout_rate = 0.1) :
        ...
        self.self_attn = TakingHeadAttention(model_dimension , num_heads)

        # Multi-head attention mechanism that attends to the encoder's output

        self.cross_attn = TakingHeadAttention(model_dimension , num_heads)
