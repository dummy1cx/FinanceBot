...
# ----------------------------------------------------------------------------------
# This is a slightly updated version of previous work
# We have integrated LSTM instead GRUs
# This idea was referenced from the Sequence to Sequence Learning
# with Neural Networks by Sutskever et all 2014
# All the refernces for the project is outlined in written report
# -----------------------------------------------------------------------------------
