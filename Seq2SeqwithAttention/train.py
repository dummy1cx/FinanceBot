...
# Embedding layer .. still on work 
# later try to implement glove or word2vec pretrained

embedding = nn.Embedding(voc.num_words, dev_config.hidden_size)

# Initialize models seq2seq 
...
# model saving with wandb artifacts along with all the model accuaracy metrics.
...
# Validation with unseen data in model training
...
# Final checkpoint after training model will get saved 
